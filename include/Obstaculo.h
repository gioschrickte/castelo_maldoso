...
namespace Entidades {
    namespace Obstaculos {
        ...
        public:
            ...
            void executar();
			virtual void obstaculizar(Personagens::Personagem* p, sf::Vector2f ds) = 0; // MÃ©todo para resolver a colisÃ£o, que pode ser implementado de forma diferente em cada tipo de obstÃ¡culo
